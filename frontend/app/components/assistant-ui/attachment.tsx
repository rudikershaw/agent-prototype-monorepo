...
const AttachmentUI: FC = () => {
	...
	// biome-ignore-start lint/a11y/useSemanticElements: Assistant UI provided component. Should contribute a fix to the library.
	return (
		<Tooltip>
	...
	// biome-ignore-end lint/a11y/useSemanticElements: Assistant UI provided component. Should contribute a fix to the library.
};
